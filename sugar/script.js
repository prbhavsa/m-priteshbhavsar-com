$(document).ready(function() {
	...
	function showScore(){
		...
		$('#sec').html(ss);
        $('#moves').html(moves);
        if(ss > 50){$('#message').html("<h3>I cant believe you took so long to solve puzzle of our wonderful picture. Try solving it in less then 50 seconds to get the 5 reasons.</h3>");}
        else {$('#message').html(getMessage(img));}
